...
def main():
    ...
    # 设置预测文件夹路径
    parser.add_argument('--input_dir', default='/media/g/mydata/branch_ly/six_images', help='Input directory containing images')

    # 设置配置文件路径
    parser.add_argument('--config',
                        default='/home/g/segmentation/mmsegmentation/configs/ddrnet/ddrnet_23-slim_in1k-pre_2xb6-120k_cityscapes-1024x1024.py',
                        help='Config file')

    # 设置权重文件路径
    parser.add_argument('--checkpoint', default='/media/g/mydata/results/ddr/ddr_06/iter_160000.pth',
                        help='Checkpoint file')

    # 设置保存输出的热力图文件夹路径
    parser.add_argument(
        '--out-dir',
        default='/media/g/mydata/results/ddr/heatmap00',
    ...
    parser.add_argument(
        ...
        # default='backbone.spp',
        default='backbone.conv_1',
        # default='backbone.vis_1',
