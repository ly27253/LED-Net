...
class EESPSPASPP(nn.Module):
    def __init__(self, in_planes, inter_planes, out_planes, block_num=3, stride_1=1, stride=1, Ker=[4,4,4], recept_limit=[23, 21, 19, 17], Spatial=False, dilation=[6,12,18,24]):
        ...
        self.conv_list.append(SESP(in_planes, inter_planes, stride=stride_1, k=Ker[0], Spatial=Spatial, SPASPP_Flag=True, r_lim=recept_limit[0]))
        self.conv_list.append(SESP(inter_planes, inter_planes, stride=stride, k=Ker[1], Spatial=Spatial, SPASPP_Flag=True, r_lim=recept_limit[1]))
        self.conv_list.append(SESP(inter_planes, inter_planes, stride=stride, k=Ker[2], Spatial=Spatial, SPASPP_Flag=True, r_lim=recept_limit[2]))
        self.conv_list.append(SESP(inter_planes, inter_planes, stride=stride, k=Ker[2], Spatial=Spatial, SPASPP_Flag=True, r_lim=recept_limit[3]))
